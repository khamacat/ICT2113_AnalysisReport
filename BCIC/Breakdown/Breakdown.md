...
| Ambiguous / Not Testable    | Requirements describe what the admin must do, not what the system must enforce. “Admin shall” is ambiguous in the system context. It is non-testable/unverifiable, because you cannot automatically verify what the admin does unless the system enforces it.        | All requirements                                | Contextual           |
